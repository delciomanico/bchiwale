...
export const TEAM = [
  {
    initials: 'BC',
    photo: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?w=300&h=300&fit=crop&q=80',
    name: 'B. Chiwale',
    role: 'Director-Geral & Fundador',
    area: 'Geologia e Mineração',
    experience: '10+ anos de experiência',
    certs: ['Geólogo Certificado', 'ISO 9001'],
  },
  {
    initials: 'DG',
    ...
    area: 'Prospecção e Depósitos Minerais',
    experience: '8+ anos de experiência',
    certs: ['PhD Geologia', 'ABNT'],
  },
  {
    initials: 'GF',
    photo: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=300&h=300&fit=crop&q=80',
    name: 'Dir. Geofísica Aplicada',
    role: 'Directora de Geofísica',
    area: 'Métodos Eléctricos e Sísmicos',
    experience: '7+ anos de experiência',
    certs: ['MSc Geofísica', 'SIT ISO'],
  },
  {
    initials: 'GT',
    photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&q=80',
    name: 'Dir. Engenharia Geotécnica',
    role: 'Director de Geotecnia',
    area: 'Fundações e Estabilidade',
    experience: '9+ anos de experiência',
    certs: ['Eng. Civil', 'ISO 45001'],
  },
  {
    initials: 'TA',
    photo: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&h=300&fit=crop&q=80',
    name: 'Dir. Topografia e Ambiente',
    role: 'Director de Topografia',
    area: 'GNSS e Sensoriamento Remoto',
    experience: '6+ anos de experiência',
    certs: ['Topógrafo Cert.', 'ABNT'],
  },
  {
    initials: 'AF',
    ...
    area: 'Gestão e Finanças',
    experience: '8+ anos de experiência',
    certs: ['MBA Gestão', 'CFA'],
  },
];
